...
void ListTester::testDestructor() {
	...
	cout << " 2 " << flush;
	cout << "Passed! "
//			<< " But double-check for memory leaks!"
			<< endl;
}
...
//	assert( fout.is_open() );
//	fout << list1.myFirst->myItem << "\n";
//	list1.writeTo(fout);
//	fout.close();
//
//	List list2;
//	list2.readFrom("ListTest1Copy.txt");
//
...
//	list1.writeTo("ListTest1Copy2.txt");
//	List list2;
//	list2.readFrom("ListTest1Copy2.txt");
//
...
//	try {
//		List1.getIndexOf(0);
//		cerr << "Successfully found index of an empty list";
//		exit(1);
//	} catch (range_error) {
//		cout << " 1 " << flush;
//	}
